...
class Experiment():
    ...
    def perform_experiment(self, rank):
        if self.config["grad_acq_func"] == "PrabuAcquistionFunction":
            grad_acq = PrabuAcquistionFunction
        elif self.config["grad_acq_func"] == "SumGradientAcquisitionFunction":
            grad_acq = SumGradientAcquisitionFunction
        else:
            grad_acq = PIGradientAcquisitionFunction
