...
parser.add_argument('-obj_fn', '--objective_function', type=str, required=True,
    ...
    ,'StyblinskiTang','DixonPrice','SixHumpCamel','ThreeHumpCamel','Sphere','Bukin','Griewank','Michalewicz','Sum_exp','cart_pole' \
    ,'pongChangeMountainCar','lunar_lander'],
...
parser.add_argument('-q', '--query_point_selection', type=str, 
    default='topk_convex', 
    choices=['convex', 'maximum', 'best', 'topk', 'topk_convex','topk_max','topk_conmax'],
