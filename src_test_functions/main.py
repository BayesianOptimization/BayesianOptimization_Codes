...
parser.add_argument('-obj_fn', '--objective_function', type=str, required=True,
    ...
    ,'StyblinskiTang','DixonPrice','SixHumpCamel','ThreeHumpCamel','Sphere','Bukin','Griewank','Michalewicz','Sum_exp'],
...
parser.add_argument('-q', '--query_point_selection', type=str, 
    default='topk_convex', 
    choices=['convex', 'maximum', 'best', 'topk', 'topk_convex','topk_max','topk_conmax','topk_convex_mean_only'\
    ,'topk_max_mean_only','topk_conmax_mean_only'],
...
parser.add_argument('-gacq', '--grad_acq_func', type=str,
    ...
    choices=['PrabuAcquistionFunction', 'SumGradientAcquisitionFunction', 'PIGradientAcquisitionFunction'],
